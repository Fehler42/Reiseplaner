...
public class Aktivitaetspanel extends JPanel {
	...
	public Aktivitaetspanel(ReisePlaner win) {
		...
		ArrayList<String> aktivitaetsNames = 
				new ArrayList<>(Arrays.asList(
						"Billige Aktivitaet",
						"Nicht so billige Aktivitaet", 
						"teure Aktivitaet", 
						"Jochen-Schweizer Aktivitaet"));
		ArrayList<Integer> aktivitaetsPrices =
				new ArrayList<>(Arrays.asList(30, 50, 100, 5000));
